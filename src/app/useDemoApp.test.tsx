...
function repository(activePage: string): DemoRepository {
  ...
  return { getState: () => state, subscribe: vi.fn(() => () => {}), reset: vi.fn(), setPreferences: vi.fn(), updateDraft: vi.fn(), completeTask: vi.fn(), rescheduleTask: vi.fn(), addVehicle: vi.fn(), updateVehicle: vi.fn(), addCustomer: vi.fn(), updateCustomer: vi.fn(), addLead: vi.fn(), updateLeadStage: vi.fn(), moveLead: vi.fn(), addDeal: vi.fn(), updateDealStatus: vi.fn(), updateFinanceDraft: vi.fn(), updateServiceJob: vi.fn(), addServiceJob: vi.fn(), updateServiceState: vi.fn(), markNotificationRead: vi.fn() };
}
