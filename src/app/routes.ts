export const pageKeys = ["my-day", "work", "inventory", "customers", "pipeline", "sales", "finance", "service", "operations"] as const;
...
export const navigationGroups: readonly NavigationGroup[] = [
  ...
  { label: "Work", destinations: [{ label: "Boards", target: { page: "work", subview: "boards" } }] },
