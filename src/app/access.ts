...
export const demoAccounts: readonly DemoAccount[] = [
  { id: "owner", role: "owner", email: "owner@motorcrm.demo", name: "Anele Dlamini", recordAssignee: "Anele Dlamini", title: "Dealership Owner", homeBranch: "Johannesburg North", allowedBranches: allBranches, dataScope: "organization", pages: allPages, permissions: allPermissions, initialTarget: { page: "my-day", subview: "overview" } },
  { id: "ceo", role: "ceo", email: "ceo@motorcrm.demo", name: "Thandi Mokoena", recordAssignee: "Thandi Mokoena", title: "Group CEO", homeBranch: "Sandton", allowedBranches: allBranches, dataScope: "organization", pages: allPages, permissions: ["branch.switch", "tasks.write", "notifications.write", "inventory.cost.read", "finance.read", "deal.financial.read", "sales.performance.read", "sales.approvals.read", "sales.export", "staff.read", "audit.read"], initialTarget: { page: "my-day", subview: "overview" } },
  ...
  { id: "salesmanager", role: "salesmanager", email: "salesmanager@motorcrm.demo", name: "Lindiwe Khumalo", recordAssignee: "Lindiwe Khumalo", title: "Sales Manager", homeBranch: "Sandton", allowedBranches: ["Sandton", "Johannesburg North"], dataScope: "branch", pages: ["my-day", "inventory", "customers", "pipeline", "sales", "finance", "operations"], permissions: ["branch.switch", "customers.write", "pipeline.write", "sales.write", "tasks.write", "notifications.write", "finance.read", "deal.financial.read", "sales.performance.read", "sales.approvals.read", "sales.export", "staff.read"], initialTarget: { page: "pipeline", subview: "board" } },
  { id: "sales", role: "sales", email: "sales@motorcrm.demo", name: "Naledi Ndlovu", recordAssignee: "Naledi Ndlovu", title: "Sales Executive", homeBranch: "Johannesburg North", allowedBranches: ["Johannesburg North"], dataScope: "own", pages: ["my-day", "inventory", "customers", "pipeline", "sales"], permissions: ["customers.write", "pipeline.write", "sales.write", "tasks.write", "notifications.write", "deal.financial.read", "sales.performance.read"], initialTarget: { page: "my-day", subview: "overview" } },
  { id: "finance", role: "finance", email: "finance@motorcrm.demo", name: "Priya Naidoo", recordAssignee: "Priya Naidoo", title: "F&I Manager", homeBranch: "Sandton", allowedBranches: ["Sandton", "Johannesburg North"], dataScope: "branch", pages: ["my-day", "customers", "sales", "finance", "operations"], permissions: ["branch.switch", "finance.write", "tasks.write", "notifications.write", "finance.read", "deal.financial.read"], initialTarget: { page: "finance", subview: "applications" } },
  { id: "stock", role: "stock", email: "stock@motorcrm.demo", name: "Kabelo Molefe", recordAssignee: "Kabelo Molefe", title: "Stock Controller", homeBranch: "Pretoria", allowedBranches: ["Pretoria", "Midrand"], dataScope: "branch", pages: ["my-day", "inventory", "service", "operations"], permissions: ["branch.switch", "inventory.write", "service.write", "tasks.write", "notifications.write", "inventory.cost.read"], initialTarget: { page: "inventory", subview: "list" } },
  { id: "marketing", role: "marketing", email: "marketing@motorcrm.demo", name: "Zanele Sithole", recordAssignee: "Zanele Sithole", title: "Marketing Specialist", homeBranch: "Midrand", allowedBranches: ["Midrand", "Sandton"], dataScope: "branch", pages: ["my-day", "inventory", "customers", "pipeline", "operations"], permissions: ["branch.switch", "pipeline.write", "tasks.write", "notifications.write"], initialTarget: { page: "customers", subview: "leads" } },
  { id: "accounts", role: "accounts", email: "accounts@motorcrm.demo", name: "Ayesha Patel", recordAssignee: "Ayesha Patel", title: "Accounts Clerk", homeBranch: "Johannesburg North", allowedBranches: ["Johannesburg North", "Sandton"], dataScope: "branch", pages: ["my-day", "sales", "finance", "operations"], permissions: ["branch.switch", "finance.write", "tasks.write", "notifications.write", "finance.read"], initialTarget: { page: "finance", subview: "deal-finance" } },
  { id: "employee", role: "employee", email: "employee@motorcrm.demo", name: "Sipho Dlamini", recordAssignee: "Sipho Dlamini", title: "Employee", homeBranch: "Midrand", allowedBranches: ["Midrand"], dataScope: "own", pages: ["my-day", "inventory", "customers", "service", "operations"], permissions: ["tasks.write", "notifications.write"], initialTarget: { page: "my-day", subview: "overview" } },
  { id: "auditor", role: "auditor", email: "auditor@motorcrm.demo", name: "Mia Botha", recordAssignee: "Mia Botha", title: "External Auditor", homeBranch: "Johannesburg North", allowedBranches: allBranches, dataScope: "organization", pages: allPages, permissions: ["branch.switch", "inventory.cost.read", "finance.read", "deal.financial.read", "sales.performance.read", "sales.approvals.read", "sales.export", "staff.read", "audit.read"], initialTarget: { page: "operations", subview: "audit-trail" } },
];
