...
export const demoAccounts: readonly DemoAccount[] = [
  ...
  { id: "accounts", role: "accounts", email: "accounts@motorcrm.demo", name: "Ayesha Patel", recordAssignee: "Ayesha Patel", title: "Accounts Clerk", organizationId: demoOrganizationId, homeBranch: "Johannesburg North", allowedBranches: ["Johannesburg North", "Sandton"], dataScope: "branch", pages: ["my-day", "work", "chat", "sales", "finance", "operations"], permissions: ["chat.write", "work.item.write", "branch.switch", "finance.write", "tasks.write", "notifications.write", "finance.read"], initialTarget: { page: "finance", subview: "deal-finance" } },
