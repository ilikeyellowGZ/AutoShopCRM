...
export const demoAccounts: readonly DemoAccount[] = [
  ...
  { id: "salesmanager", role: "salesmanager", email: "salesmanager@motorcrm.demo", name: "Lindiwe Khumalo", recordAssignee: "Lindiwe Khumalo", title: "Sales Manager", organizationId: demoOrganizationId, homeBranch: "Sandton", allowedBranches: ["Sandton", "Johannesburg North"], dataScope: "branch", pages: ["my-day", "inventory", "customers", "pipeline", "sales", "finance", "operations"], permissions: ["branch.switch", "customers.write", "pipeline.write", "sales.write", "tasks.write", "notifications.write", "finance.read", "deal.financial.read", "sales.performance.read", "sales.approvals.read", "sales.export", "staff.read"], initialTarget: { page: "pipeline", subview: "board" } },
  { id: "sales", role: "sales", email: "sales@motorcrm.demo", name: "Naledi Ndlovu", recordAssignee: "Naledi Ndlovu", title: "Sales Executive", organizationId: demoOrganizationId, homeBranch: "Johannesburg North", allowedBranches: ["Johannesburg North"], dataScope: "own", pages: ["my-day", "inventory", "customers", "pipeline", "sales"], permissions: ["customers.write", "pipeline.write", "sales.write", "tasks.write", "notifications.write", "deal.financial.read", "sales.performance.read"], initialTarget: { page: "my-day", subview: "overview" } },
  { id: "finance", role: "finance", email: "finance@motorcrm.demo", name: "Priya Naidoo", recordAssignee: "Priya Naidoo", title: "F&I Manager", organizationId: demoOrganizationId, homeBranch: "Sandton", allowedBranches: ["Sandton", "Johannesburg North"], dataScope: "branch", pages: ["my-day", "customers", "sales", "finance", "operations"], permissions: ["branch.switch", "finance.write", "tasks.write", "notifications.write", "finance.read", "deal.financial.read"], initialTarget: { page: "finance", subview: "applications" } },
  ...
  { id: "marketing", role: "marketing", email: "marketing@motorcrm.demo", name: "Zanele Sithole", recordAssignee: "Zanele Sithole", title: "Marketing Specialist", organizationId: demoOrganizationId, homeBranch: "Midrand", allowedBranches: ["Midrand", "Sandton"], dataScope: "branch", pages: ["my-day", "inventory", "customers", "pipeline", "operations"], permissions: ["branch.switch", "pipeline.write", "tasks.write", "notifications.write"], initialTarget: { page: "customers", subview: "leads" } },
  { id: "accounts", role: "accounts", email: "accounts@motorcrm.demo", name: "Ayesha Patel", recordAssignee: "Ayesha Patel", title: "Accounts Clerk", organizationId: demoOrganizationId, homeBranch: "Johannesburg North", allowedBranches: ["Johannesburg North", "Sandton"], dataScope: "branch", pages: ["my-day", "sales", "finance", "operations"], permissions: ["branch.switch", "finance.write", "tasks.write", "notifications.write", "finance.read"], initialTarget: { page: "finance", subview: "deal-finance" } },
