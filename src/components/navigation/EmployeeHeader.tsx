...
export function EmployeeHeader({ branch, employeeName, employeeRole, actionCount = 0, notificationCount = 0, onSearch, onBranch, onActionCentre, onNotifications, onEmployeeMenu, onOpenDestinations, destinationTriggerRef }: EmployeeHeaderProps) {
